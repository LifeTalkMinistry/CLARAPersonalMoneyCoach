    ...
    >
      ...
      <div className="relative h-[120px] w-full">
        ...
        <div className="absolute left-4 top-4 max-w-[72%]">
          ...
          <p className="mt-3 text-[10px] font-black uppercase tracking-[0.32em] text-white/64">
            {title}
          </p>
          ...
          <p className="mt-1 line-clamp-1 text-xs font-medium text-white/50">
            {caption}
          </p>
        </div>

        <div className="absolute right-4 top-1/2 -translate-y-1/2">
          <div className="relative flex h-12 w-12 items-center justify-center rounded-full border border-white/14 bg-white/[0.09] shadow-[inset_0_1px_0_rgba(255,255,255,0.14),0_0_24px_rgba(255,255,255,0.08)] backdrop-blur-xl transition-all duration-300 group-hover:scale-105 group-hover:bg-white/[0.13] group-active:scale-95">
