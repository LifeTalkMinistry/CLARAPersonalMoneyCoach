  ...
  return (
    <div className="w-full px-4">
      <section
        ...
        className="flex snap-x snap-mandatory gap-4 overflow-x-auto overflow-y-visible scroll-smooth pb-2 scrollbar-none"
      >
        {items.map((item, index) => {
          ...
          const scale = isActive ? 1.03 : 0.96;
          const opacity = isActive ? 1 : 0.75;
          const translateY = isActive ? -6 : absDistance * 10;
            ...
            >
              <div
                className="
                  ...
                  shadow-[0_20px_40px_rgba(0,0,0,0.45),0_40px_80px_rgba(0,0,0,0.30)]
