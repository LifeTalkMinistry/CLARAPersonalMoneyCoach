        ...
        >
          ...
          <div className="relative z-10 mb-2 flex shrink-0 items-start justify-between gap-3">
            <div className="flex min-w-0 items-start gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-[#B9F632]/20 bg-[#B9F632]/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
